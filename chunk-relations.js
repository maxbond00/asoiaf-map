...
(function(){
  const R = {
    ...
    'jon-snow':          [{id:'ghost',type:'Direwolf'},{id:'ned-stark',type:'Father (believed)'},{id:'ygritte',type:'Lover'},{id:'samwell-tarly',type:'Best friend'},{id:'stannis-baratheon',type:'Unlikely ally'},{id:'tormund',type:'Ally'}],
    ...
    'cersei-lannister':  [{id:'tywin-lannister',type:'Father'},{id:'jaime-lannister',type:'Twin / Lover'},{id:'tyrion-lannister',type:'Despised brother'},{id:'joffrey',type:'Son'},{id:'tommen',type:'Son'},{id:'littlefinger',type:'Political rival'}],
    'jaime-lannister':   [{id:'cersei-lannister',type:'Twin / Lover'},{id:'tyrion-lannister',type:'Brother'},{id:'tywin-lannister',type:'Father'},{id:'brienne',type:'Oath-bound companion'},{id:'beric-dondarrion',type:'Enemy'}],
    ...
    'joffrey': [{id:'cersei-lannister',type:'Mother'},{id:'robert-baratheon',type:'Father (believed)'},{id:'jaime-lannister',type:'True father'},{id:'sansa-stark',type:'Ex-betrothed'},{id:'margaery-tyrell',type:'Wife'}],
    ...
    'sandor-clegane':    [{id:'gregor-clegane',type:'Hated brother'},{id:'arya-stark',type:'Captor / Protector'},{id:'joffrey',type:'Served'}],
