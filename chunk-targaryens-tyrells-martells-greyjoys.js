...
Object.assign(window.CHARS, {
  ...
  'daenerys': {
    ...
    portrait: 'daenerys',
    photoUrl: 'https://thronesapi.com/assets/images/daenerys.jpg',
    isKing: true,
  ...
  'viserys': {
    ...
    portrait: 'viserys',
    photoUrl: 'https://thronesapi.com/assets/images/viserys.jpg',
    isKing: true,
    deathBook: 0,
  ...
  'jorah-mormont': {
    ...
    portrait: 'jorah',
    photoUrl: 'https://thronesapi.com/assets/images/jorah-mormont.jpg',
  ...
  'barristan-selmy': {
    ...
    portrait: 'barristan',
    photoUrl: 'https://thronesapi.com/assets/images/barristan-selmy.jpg',
    deathBook: 4,
  ...
  'missandei': {
    ...
    aliases: [],
    portrait: 'missandei',
    photoUrl: 'https://thronesapi.com/assets/images/missandei.jpg',
  ...
  'grey-worm': {
    ...
    aliases: [],
    portrait: 'grey-worm',
    photoUrl: 'https://thronesapi.com/assets/images/grey-worm.jpg',
  ...
  'olenna-tyrell': {
    ...
    portrait: 'olenna',
    photoUrl: 'https://thronesapi.com/assets/images/olenna-tyrell.jpg',
  ...
  'margaery-tyrell': {
    ...
    portrait: 'margaery',
    photoUrl: 'https://thronesapi.com/assets/images/margaery-tyrell.jpg',
    isKing: true,
  ...
  'loras-tyrell': {
    ...
    portrait: 'loras',
    photoUrl: 'https://thronesapi.com/assets/images/loras-tyrell.jpg',
  ...
  'oberyn-martell': {
    ...
    portrait: 'oberyn',
    photoUrl: 'https://thronesapi.com/assets/images/oberyn-martell.jpg',
    deathBook: 2,
  ...
  'nymeria-sand': {
    ...
    photoUrl: 'https://thronesapi.com/assets/images/nymeria-sand.jpg',
  ...
  'obara-sand': {
    ...
    aliases: [],
    portrait: 'obara-sand',
    photoUrl: 'https://thronesapi.com/assets/images/obara-sand.jpg',
  ...
  'tyene-sand': {
    ...
    aliases: [],
    portrait: 'tyene-sand',
    photoUrl: 'https://thronesapi.com/assets/images/tyene-sand.jpg',
  ...
  'balon-greyjoy': {
    ...
    photoUrl: 'https://thronesapi.com/assets/images/balon-greyjoy.jpg',
    isKing: true,
    deathBook: 2,
  ...
  'theon-greyjoy': {
    ...
    portrait: 'theon',
    photoUrl: 'https://thronesapi.com/assets/images/theon-greyjoy.jpg',
  ...
  'yara-greyjoy': {
    ...
    portrait: 'yara',
    photoUrl: 'https://thronesapi.com/assets/images/yara-greyjoy.jpg',
  ...
  'euron-greyjoy': {
    ...
    portrait: 'euron',
    photoUrl: 'https://thronesapi.com/assets/images/euron-greyjoy.jpg',
    isKing: true,
  ...
  'edmure-tully': {
    ...
    aliases: ['Lord Edmure'],
    portrait: 'edmure',
    photoUrl: 'https://thronesapi.com/assets/images/edmure-tully.jpg',
  ...
  'lysa-arryn': {
    ...
    aliases: ['Lady Arryn'],
    portrait: 'lysa-arryn',
    photoUrl: 'https://thronesapi.com/assets/images/lysa-arryn.jpg',
    deathBook: 2,
  ...
  'littlefinger': {
    ...
    photoUrl: 'https://thronesapi.com/assets/images/petyr-baelish.jpg',
  ...
  'varys': {
    ...
    portrait: 'varys',
    photoUrl: 'https://thronesapi.com/assets/images/varys.jpg',
  ...
  'sandor-clegane': {
    ...
    portrait: 'sandor',
    photoUrl: 'https://thronesapi.com/assets/images/sandor-clegane.jpg',
  ...
  'brienne': {
    ...
    portrait: 'brienne',
    photoUrl: 'https://thronesapi.com/assets/images/brienne-of-tarth.jpg',
  ...
  'podrick-payne': {
    ...
    aliases: ['Pod'],
    portrait: 'podrick',
    photoUrl: 'https://thronesapi.com/assets/images/podrick-payne.jpg',
  ...
  'bronn': {
    ...
    portrait: 'bronn',
    photoUrl: 'https://thronesapi.com/assets/images/bronn.jpg',
  ...
  'beric-dondarrion': {
    ...
    portrait: 'beric',
    photoUrl: 'https://thronesapi.com/assets/images/beric-dondarrion.jpg',
    deathBook: 2,
  ...
  'thoros-of-myr': {
    ...
    aliases: [],
    portrait: 'thoros',
    photoUrl: 'https://thronesapi.com/assets/images/thoros-of-myr.jpg',
  ...
  'gendry': {
    ...
    aliases: ['The Bull'],
    portrait: 'gendry',
    photoUrl: 'https://thronesapi.com/assets/images/gendry.jpg',
